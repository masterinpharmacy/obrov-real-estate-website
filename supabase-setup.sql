...
-- 8. MIGRATIE voor bestaande installaties
-- Veilig opnieuw uit te voeren: voegt alleen toe wat nog niet bestaat.
...
-- Bestaande woningen die noch nieuwbouw noch renovatie zijn, zijn bestaande bouw.
UPDATE woningen
