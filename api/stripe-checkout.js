...
export default async function handler(req, res) {
  ...
  if (!STRIPE_SECRET) {
    return res.status(503).json({ error: "Betaling tijdelijk niet beschikbaar. Neem contact op via info@obrovrealestate.nl om uw woning te plaatsen.", unavailable: true });
  }
