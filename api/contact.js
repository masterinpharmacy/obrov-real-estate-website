...
export default async function handler(req, res) {
  ...
  try {
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        // Resend requires the "from" address to use a domain you've verified
        // in your Resend account. Until obrovrealestate.nl is verified there,
        // use Resend's shared testing domain "onboarding@resend.dev" here.
        from: "Obrov Real Estate website <onboarding@resend.dev>",
