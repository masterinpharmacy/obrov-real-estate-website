  ...
  return (
    <div style={{ fontFamily: "Helvetica, Arial, sans-serif", background: "#FAF8F4", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ textAlign: "center", maxWidth: 480 }}>
        ...
        <h1 style={{ fontFamily: "Georgia, serif", fontSize: 28, color: "#0B2A52", margin: "0 0 16px" }}>Betaling geslaagd!</h1>
        <p style={{ fontSize: 15, color: "#3D3D3D", lineHeight: 1.7, marginBottom: 24 }}>
          Uw woning is nu zichtbaar op Obrov Real Estate. Wij nemen binnen twee werkdagen contact op om een professionele fotosessie in te plannen.
        </p>
        <a href="/aanbod" style={{ background: "#0B2A52", color: "#fff", padding: "14px 28px", borderRadius: 3, textDecoration: "none", fontWeight: 700, fontSize: 15 }}>
          Bekijk het aanbod →
        </a>
      </div>
    </div>
