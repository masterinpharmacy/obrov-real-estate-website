...
import FAQPagina from './FAQPagina.jsx'
import FavorietenPagina from './FavorietenPagina.jsx'
import AdverterenPagina from './AdverterenPagina.jsx'
  ...
  <React.StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/faq" element={<FAQPagina />} />
        <Route path="/favorieten" element={<FavorietenPagina />} />
        <Route path="/adverteren" element={<AdverterenPagina />} />
