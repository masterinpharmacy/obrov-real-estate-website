...
const CONTENT = {
  nl: {
    ...
    destinationLands: [
      ...
      },
      {
        land: "Slovenië",
        flag: "🇸🇮",
        why: "EU-lid, euro als valuta, stabiele rechtsstaat, populair bij Nederlandse investeerders.",
        spots: [
  ...
  en: {
    ...
    destinationLands: [
      ...
      },
      {
        land: "Slovenia",
        flag: "🇸🇮",
        why: "EU member, euro as currency, stable rule of law, popular with Dutch investors.",
        spots: [
  ...
  sv: {
    ...
    navAanbod: "Se utbud",
    heroBadge: "NEDERLÄNDSK — MONTENEGRINSK INVESTERINGSBYRÅ",
    heroTitle1: "Investera i Montenegro,",
    heroTitle2: "utan att chansa.",
    heroText:
      "Vi guidar nederländska investerare från första mötet till notariell överlåtelse — med lokala kontakter, juridisk säkerhet och skräddarsydd skatterådgivning. Inga mellanhänder, en fast kontaktperson.",
    heroCta1: "Begär ett introduktionsmöte",
    heroCta2: "Se vårt tillvägagångssätt",
    ...
    aboutKicker: "OM OSS",
    aboutTitle: "Engagerade för personlig, kvalitativ vägledning",
    aboutQuote: "Vi tror att fastighetsinvesteringar bara känns rätt när varje steg guidas personligt och förklaras tydligt.",
    aboutQuoteAttr: "— Obrov Real Estate",
    aboutP1: "Obrov Real Estate är engagerat i personlig och kvalitativ vägledning vid köp och försäljning av nybyggnadsprojekt, investeringar och befintliga bostäder i Montenegro.",
    aboutP2: "Vi arbetar med ett fast nätverk av lokala jurister och en nederländsk skatterådgivare, så att varje transaktion inte bara är attraktiv utan också juridiskt och skattemässigt sund.",
    ...
    devTitle: "Presentera ditt projekt för nederländska investerare",
  ...
  fr: {
    ...
    heroBadge: "AGENCE D'INVESTISSEMENT NÉERLANDO-MONTÉNÉGRINE",
    heroTitle1: "Investir au Monténégro,",
    heroTitle2: "sans prendre de risques.",
    heroText:
    ...
    heroCta1: "Demander une introduction",
    heroCta2: "Voir notre approche",
    ...
    aboutTitle: "Dédiés à un accompagnement personnel et qualitatif",
    aboutQuote: "Nous croyons que l'investissement immobilier ne se sent bien que lorsque chaque étape est guidée personnellement et clairement expliquée.",
    aboutQuoteAttr: "— Obrov Real Estate",
    aboutP1: "Obrov Real Estate est dédié à un accompagnement personnel et qualitatif lors de l'achat et de la vente de projets neufs, d'investissements et de logements existants au Monténégro.",
    aboutP2: "Nous travaillons avec un réseau fixe d'avocats locaux et un conseiller fiscal néerlandais, de sorte que chaque transaction soit non seulement attrayante, mais aussi juridiquement et fiscalement solide.",
    ...
    devTitle: "Présentez votre projet aux investisseurs néerlandais",
    devIntro: "Obrov Real Estate connecte votre projet de construction neuve directement à un groupe croissant d'investisseurs néerlandais qui recherchent activement des biens au Monténégro.",
  ...
  lb: {
    ...
    heroBadge: "NÉIERLÄNDESCH — MONTENEGREINESCH INVESTITIOUNSAGENCE",
    heroTitle1: "An Montenegro investéieren,",
    heroTitle2: "ouni ze riskéieren.",
    heroText:
    ...
    heroCta1: "Eng Presentatioun ufroen",
    heroCta2: "Eise Wee gesinn",
    ...
    aboutTitle: "Engagéiert fir perséinlech, qualitativ Begleedung",
    aboutQuote: "Mir gleewen, datt Immobilien-Investissementer nëmmen da richteg fillen, wann all Schrëtt perséinlech begleet a kloer erkläert gëtt.",
    aboutQuoteAttr: "— Obrov Real Estate",
    aboutP1: "Obrov Real Estate ass engagéiert fir perséinlech a qualitativ Begleedung beim Kaf a Verkaf vu Neibauprojet, Investitiounen a Bestandsimmobilien a Montenegro.",
    aboutP2: "Mir schaffen mat engem feste Netzwierk vun lokale Juristen an engem néierländesche Steierberoder, sou datt all Transaktioun net nëmme attraktiv, mee och juristesch a steierlech fundéiert ass.",
    ...
    devTitle: "Presentéiert äre Projet néierländesche Investisseuren",
  ...
  bs: {
    ...
    heroText: "Vodimo holandske investitore od prvog upoznavanja do notarskog prijenosa vlasništva — uz lokalne kontakte sa investitorima, pravnu sigurnost i prilagođene porezne savjete. Bez posrednika, jedna kontakt osoba.",
    heroCta1: "Zatražite upoznavanje",
    heroCta2: "Pogledajte naš pristup",
    ...
    aboutKicker: "O NAMA",
    aboutTitle: "Posvećeni ličnoj i kvalitetnoj podršci",
    aboutQuote: "Vjerujemo da ulaganje u nekretnine ima smisla samo kada je svaki korak lično vođen i jasno objašnjen.",
    aboutQuoteAttr: "— Obrov Real Estate",
    aboutP1: "Obrov Real Estate je posvećen ličnoj i kvalitetnoj podršci u kupovini i prodaji novogradnje, investicija i postojećih nekretnina u Crnoj Gori.",
    aboutP2: "Radimo sa stalnom mrežom lokalnih advokata i holandskim poreznim savjetnikom, tako da je svaka transakcija pravno i porezno dobro utemeljena.",
    contactTitle: "Započnite razgovorom bez obaveza",
    contactText: "Recite nam vašu situaciju i cilj. Lično ćemo vas kontaktirati u roku od dva radna dana.",
    formName: "Vaše ime",
    formEmail: "Email adresa",
  ...
  hr: {
    ...
    navCta: "Zakažite razgovor",
    navAanbod: "Pogledajte ponudu",
    heroBadge: "NIZOZEMSKO — CRNOGORSKA INVESTICIJSKA AGENCIJA",
    heroTitle1: "Ulaganje u Crnu Goru,",
    heroTitle2: "bez rizika.",
    heroText: "Vodimo nizozemske investitore od prvog upoznavanja do javnobilježničkog prijenosa vlasništva — uz lokalne kontakte s investitorima, pravnu sigurnost i prilagođene porezne savjete. Bez posrednika, jedna kontakt osoba.",
    heroCta1: "Zatražite upoznavanje",
    heroCta2: "Pogledajte naš pristup",
    stat1v: "100%", stat1l: "Euro tržište — nema valutnog rizika",
    ...
    aboutKicker: "O NAMA",
    aboutTitle: "Posvećeni osobnoj, kvalitetnoj podršci",
    aboutQuote: "Vjerujemo da ulaganje u nekretnine ima smisla samo kada je svaki korak osobno vođen i jasno objašnjen.",
    aboutQuoteAttr: "— Obrov Real Estate",
    aboutP1: "Obrov Real Estate posvećen je osobnoj i kvalitetnoj podršci pri kupnji i prodaji projekata novogradnje, ulaganja i postojećih nekretnina u Crnoj Gori.",
    aboutP2: "Surađujemo s stalnom mrežom lokalnih odvjetnika i nizozemskim poreznim savjetnikom kako bi svaka transakcija bila pravno i porezno dobro utemeljena.",
    ...
    devKicker: "ZA PROJEKTNE INVESTITORE",
    devTitle: "Predstavite svoj projekt nizozemskim investitorima",
  ...
  sl: {
    ...
    heroBadge: "NIZOZEMSKO — ČRNOGORSKA INVESTICIJSKA AGENCIJA",
    heroTitle1: "Vlaganje v Črno goro,",
    heroTitle2: "brez tveganja.",
    heroText: "Vodimo nizozemske vlagatelje od prvega srečanja do notarskega prenosa lastništva — z lokalnimi stiki z investitorji, pravno varnostjo in prilagojenimi davčnimi nasveti. Brez posrednikov, ena stalna kontaktna oseba.",
    heroCta1: "Zahtevajte predstavitev",
    heroCta2: "Oglejte si naš pristop",
    ...
    aboutKicker: "O NAS",
    aboutTitle: "Posvečeni osebni, kakovostni podpori",
    aboutQuote: "Verjamemo, da se vlaganje v nepremičnine dobro počuti le, ko je vsak korak osebno voden in jasno razložen.",
    aboutQuoteAttr: "— Obrov Real Estate",
    aboutP1: "Obrov Real Estate je posvečen osebni in kakovostni podpori pri nakupu in prodaji projektov novogradenj, naložb in obstoječih stanovanj v Črni gori.",
    aboutP2: "Sodelujemo s stalno mrežo lokalnih odvetnikov in nizozemskim davčnim svetovalcem, tako da je vsaka transakcija ne le privlačna, temveč tudi pravno in davčno dobro utemeljena.",
    ...
    devTitle: "Predstavite svoj projekt nizozemskim vlagateljem",
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, flexShrink: 0 }}>
          ...
          <a
            ...
            style={{ background: "#AC9362", color: "#FAF8F4", padding: "10px 18px", borderRadius: 2, fontSize: 13.5, fontWeight: 600, textDecoration: "none", whiteSpace: "nowrap" }}
          >
            {t.navAanbod || "Aanbod"}
          </a>
        </div>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 24, flexWrap: "wrap", justifyContent: "center" }}>
          {lands.map((land, i) => (
            ...
            >
              {land.flag} {land.land}
              {i === 0 && (
                <span style={{ fontSize: 10, fontWeight: 700, background: "#AC9362", color: "#fff", padding: "2px 7px", borderRadius: 10, marginLeft: 2 }}>
                  KERN
                </span>
              )}
            </button>
