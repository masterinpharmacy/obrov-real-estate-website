...
const CONTENT = {
  nl: {
    ...
    platformOntwikkelaarPunten: [
      ...
      "Exclusieve vertegenwoordiging in Nederland, Duitsland, Luxemburg en Zweden",
      "Presentatie aan actief Europees investeringsnetwerk",
      "Commissie per verkochte unit — geen vaste kosten",
      "Heldere contracten, geen verborgen kosten",
    ],
