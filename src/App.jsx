      ...
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            {/* Voordelen */}
            {[
              { icon: null, tekst: "Exclusieve vertegenwoordiging in Nederland" },
              { icon: null, tekst: "Commissie per verkochte unit" },
              { icon: null, tekst: "Presentatie aan actief Nederlands netwerk" },
