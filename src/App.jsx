    ...
    <section style={{ background: "#0B2A52", padding: "48px 24px 52px" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          <div style={{ fontSize: 12.5, color: "#AC9362", fontWeight: 700, letterSpacing: 1.5, marginBottom: 10 }}>VASTGOED ZOEKEN</div>
          <h2 style={{ fontFamily: "Georgia, serif", fontSize: "clamp(22px, 3vw, 32px)", color: "#FAF8F4", margin: 0, fontWeight: 700 }}>
            Vind uw woning in Montenegro & de Balkan
          </h2>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
          <div style={{ fontSize: 12.5, color: "#C2A877", fontWeight: 700, letterSpacing: 1.5 }}>ACTUEEL AANBOD</div>
          <Link
            to="/aanbod"
            style={{ color: "#C2A877", fontSize: 13.5, fontWeight: 600, textDecoration: "none", borderBottom: "1px solid #AC9362", paddingBottom: 1 }}
          >
            Volledig aanbod bekijken ({DEMO_WONINGEN.length} woningen) →
          </Link>
        </div>
        {/* Woningkaarten grid */}
      ...
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            {/* Voordelen */}
            {[
              { icon: "🤝", tekst: "Exclusieve vertegenwoordiging in Nederland" },
              { icon: "🎯", tekst: "Commissie per verkochte unit" },
              { icon: "📣", tekst: "Presentatie aan actief Nederlands netwerk" },
              { icon: "📋", tekst: "Heldere contracten, geen verborgen kosten" },
            ].map((item, i) => (
