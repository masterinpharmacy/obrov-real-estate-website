...
const CONTENT = {
  nl: {
    ...
    aboutP1:
      "Obrov Real Estate vervult twee complementaire rollen. Voor Nederlandse investeerders zijn wij de gids: wij zoeken passende woningen of projecten, organiseren bezichtigingsreizen, begeleiden de juridische en fiscale afhandeling, en bewaken elk detail tot aan de sleuteloverdracht. Onze vergoeding is een transparante begeleidingsvergoeding of een percentage van de aankoopprijs.",
    aboutP2:
  ...
  en: {
    ...
    aboutQuoteAttr: "— Obrov Real Estate",
    aboutP1:
      "Obrov Real Estate fulfils two complementary roles. For Dutch investors, we are the guide: we find suitable properties or projects, organise viewing trips, handle the legal and tax process, and oversee every detail through to key handover. Our fee is a transparent guidance fee or a percentage of the purchase price.",
    aboutP2:
  ...
  de: {
    ...
    aboutQuoteAttr: "— Obrov Real Estate",
    aboutP1:
      "Obrov Real Estate erfüllt zwei komplementäre Rollen. Für niederländische Investoren sind wir der Leitfaden: Wir finden geeignete Immobilien oder Projekte, organisieren Besichtigungsreisen, begleiten den rechtlichen und steuerlichen Prozess und überwachen jedes Detail bis zur Schlüsselübergabe. Unsere Vergütung ist eine transparente Begleitgebühr oder ein Prozentsatz des Kaufpreises.",
    aboutP2:
...
function AanbodPreview() {
  ...
  return (
    <section style={{ background: "#F2EDE0", padding: "52px 24px 56px", borderBottom: "1px solid #DCD4C2" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        {/* Header */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 28, flexWrap: "wrap", gap: 12 }}>
          <div>
            <div style={{ fontSize: 12.5, color: "#AC9362", fontWeight: 700, letterSpacing: 1.5, marginBottom: 8 }}>ACTUEEL AANBOD</div>
            <h2 style={{ fontFamily: "Georgia, serif", fontSize: "clamp(22px, 3vw, 30px)", color: "#0B2A52", margin: 0, fontWeight: 700 }}>
              Beschikbare woningen & projecten
            </h2>
          </div>
          <Link
            to="/aanbod"
            style={{ background: "#0B2A52", color: "#fff", padding: "11px 22px", borderRadius: 3, fontSize: 14, fontWeight: 700, textDecoration: "none", whiteSpace: "nowrap" }}
          >
        ...
        <div style={{ textAlign: "center", marginTop: 28 }}>
          <Link to="/aanbod" style={{ fontSize: 14, color: "#0B2A52", fontWeight: 600, textDecoration: "none", borderBottom: "1.5px solid #AC9362", paddingBottom: 2 }}>
            Bekijk alle {DEMO_WONINGEN.length} woningen & projecten →
          </Link>
        </div>
      </div>
    </section>
