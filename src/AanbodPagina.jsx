  ...
  useEffect(() => {
    async function laad() {
      ...
      try {
        ...
        // Als Supabase niet geconfigureerd is of leeg is, toon demo-woningen
    ...
    <div style={{ fontFamily: "Helvetica, Arial, sans-serif", background: "#FAF8F4", minHeight: "100vh" }}>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .filter-bar{position:sticky;top:66px;z-index:45;background:#fff;border-bottom:1px solid ${BORDER}}
      `}</style>
