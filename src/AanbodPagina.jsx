      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        @media(max-width:768px){
          .zij-layout{flex-direction:column!important;padding:12px 0 40px!important}
          ...
          .filter-toggle-btn{display:flex!important;margin:0 12px 12px!important}
          .woningen-grid{grid-template-columns:1fr!important;padding:0 12px}
          .kaart-wrapper-mobiel{margin:0!important}
        }
