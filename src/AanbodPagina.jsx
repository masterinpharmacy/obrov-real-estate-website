...
export default function AanbodPagina() {
  ...
  return (
    <div style={{ fontFamily: "Helvetica, Arial, sans-serif", background: "#FAF8F4", minHeight: "100vh" }}>
      <style>{`html,body{overflow-x:hidden;max-width:100%}*{box-sizing:border-box}@media(max-width:768px){.zij-layout{flex-direction:column!important}.filter-paneel{position:static!important;width:100%!important;top:auto!important}}`}</style>
      ...
      <div className="zij-layout" style={{ maxWidth: 1280, margin: "0 auto", padding: "24px 24px 60px", display: "flex", gap: 24, alignItems: "flex-start" }}>
        ...
        {/* FILTER PANEEL LINKS */}
        <div className="filter-paneel" style={{ width: 240, flexShrink: 0 }}>
          <FilterPaneel
            filters={filters}
            setF={setF}
            woningen={woningen}
