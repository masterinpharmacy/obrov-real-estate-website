...
export default function AuthPagina() {
  ...
  const redirect = params.get("redirect") || "/woning-plaatsen";
          ...
          {modus === "registreren" && (
            <form onSubmit={handleRegistreren} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: "#888", marginTop: 4 }}>Minimaal 8 tekens</div>
              </div>
              ...
              <div style={{ textAlign: "center", fontSize: 13, color: "#6B6B6B" }}>
                ...
                <Link to="/woning-plaatsen" style={{ color: NAVY, fontWeight: 600 }}>algemene voorwaarden</Link>.
              </div>
