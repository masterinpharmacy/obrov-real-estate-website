...
export default function AuthPagina() {
  ...
  const handleRegistreren = async (e) => {
    ...
    if (!supabase) {
      setFout("Database niet beschikbaar. Neem contact op via info@obrovrealestate.nl.");
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      setFout("Verbindingsfout. Controleer uw internetverbinding.");
    } finally {
      setLoading(false);
    }
  };
