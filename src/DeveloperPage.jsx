...
const CONTENT = {
  nl: {
    ...
    heroTitle: "Breng uw project onder de aandacht van Nederlandse investeerders",
    heroText:
      "Obrov Real Estate verbindt uw nieuwbouwproject rechtstreeks met een groeiende groep Nederlandse investeerders die actief zoeken naar vastgoed aan de Montenegrijnse kust. Wij treden op als uw exclusieve of preferred vertegenwoordiger in Nederland — persoonlijk, professioneel en gericht op resultaat.",
    benefitsTitle: "Wat samenwerken oplevert",
    benefits: [
      { title: "Directe toegang tot gemotiveerde kopers", text: "Wij onderhouden een actief netwerk van Nederlandse investeerders die klaarstaan om te investeren in Montenegro." },
      ...
      { title: "Marketing richting Nederlandse markt", text: "Uw project gepresenteerd in het Nederlands, afgestemd op wat Nederlandse investeerders zoeken." },
    ],
  ...
  en: {
    ...
    heroTitle: "Bring your project to the attention of Dutch investors",
    heroText:
      "Obrov Real Estate connects your new-build project directly with a growing group of Dutch investors actively looking for property on the Montenegrin coast. We act as your exclusive or preferred representative in the Netherlands — personal, professional and results-driven.",
    benefitsTitle: "What collaboration delivers",
    benefits: [
      { title: "Direct access to motivated buyers", text: "We maintain an active network of Dutch investors ready to invest in Montenegro." },
      ...
      { title: "Marketing to the Dutch market", text: "Your project presented in Dutch, tailored to what Dutch investors are looking for." },
    ],
  ...
  de: {
    ...
    heroTitle: "Bringen Sie Ihr Projekt niederländischen Investoren näher",
    heroText:
    ...
    benefits: [
      { title: "Direkter Zugang zu motivierten Käufern", text: "Wir pflegen ein aktives Netzwerk niederländischer Investoren, die bereit sind, in Montenegro zu investieren." },
      ...
      { title: "Marketing für den niederländischen Markt", text: "Ihr Projekt auf Niederländisch präsentiert, abgestimmt auf die Erwartungen niederländischer Investoren." },
    ],
  ...
  me: {
    ...
    heroTitle: "Predstavite vaš projekat holandskim investitorima",
    heroText:
      "Obrov Real Estate direktno povezuje vaš projekat novogradnje sa rastućom grupom holandskih investitora koji aktivno traže nekretnine na crnogorskom primorju. Nastupamo kao vaš ekskluzivni ili preferirani zastupnik u Holandiji — lično, profesionalno i orijentisano na rezultate.",
